...
RSpec.describe 'Post show page', type: :feature do
  let(:user) { User.create(name: 'Bruno', photo: 'https://photos.jpg', bio: 'This is my bio', posts_counter: 1) }
  ...
  describe 'Display the username and comment of each commentor' do
    before do
      user1 = User.create(id: 5, name: 'Bruno', posts_counter: 1, bio: 'Bio 1', photo: 'https://photos.jpg')
      user2 = User.create(id: 6, name: 'Obiba', posts_counter: 1, bio: 'Bio 1', photo: 'https://photos.jpg')
    ...
    it 'displays the username of each commentor' do
      ...
      expect(page).to have_content('Obiba')
    end
