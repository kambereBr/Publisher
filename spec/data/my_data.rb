module FakerData
  def fetch_data
    @user1 = User.create(name: 'Bruno', photo: 'https://photos.jpg', bio: 'This is my bio', posts_counter: 1)
    @user2 = User.create(name: 'Anwar', photo: 'https://photos.jpg', bio: 'This is my bio', posts_counter: 2)
    @user3 = User.create(name: 'Hussaini', photo: 'https://photos.jpg', bio: 'This is my bio', posts_counter: 3)
    @user4 = User.create(name: 'Kambere', photo: 'https://photos.jpg', bio: 'This is my bio', posts_counter: 4)
